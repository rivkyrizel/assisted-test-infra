...
from consts import ClusterStatus, HostsProgressStages, env_defaults, CensoredConfig
...
def _censor_storage_files(data: dict) -> bool:
    ...
    for file_entry in files:
        ...
        if (
            path.endswith(CensoredConfig.SENSITIVE_EXTENSIONS)
            or path in CensoredConfig.EXACT_PATHS
        ):
           if (
